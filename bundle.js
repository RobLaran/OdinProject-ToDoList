...
;// ./src/modules/models/list.model.js
// List model
...
;// ./src/modules/models/task.model.js
// Task model


// Create task
function createTask(title="Untitled task",description="",dueDate=format(new Date(), "MMMM dd, yyyy"),priority="low",notes="A note to guide my task", completed=false) {
    return {
        title,
        description,
        dueDate,
...
;// ./src/modules/views/modal.view.js
...
;// ./src/modules/views/list.view.js
// List view
...
;// ./src/modules/views/task.view.js
// Task view
...
;// ./src/modules/models/storage.model.js



//  Add localStorage
function loadList(name="data") {
...
const changeList = (index) => currentList = index;
